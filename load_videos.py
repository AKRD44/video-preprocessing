...
if __name__ == "__main__":
    """
    python load_videos.py --metadata ted-metadata.csv --format .png --out_folder D:\ted --workers 8 --youtube .\youtube-dl.exe
    """
    parser = ArgumentParser()
    parser.add_argument("--video_folder", default='video_folder', help='Path to youtube videos')
    parser.add_argument("--metadata", default='ted-metadata.csv', help='Path to metadata')
    parser.add_argument("--out_folder", default='D:/ted', help='Path to output')
    parser.add_argument("--format", default='.png', help='Storing format')
    parser.add_argument("--workers", default=-1, type=int, help='Number of workers')
    parser.add_argument("--youtube", default='.\youtube-dl.exe', help='Path to youtube-dl')
    ...
    nber_workers=args.workers
    if nber_workers==-1:
        import multiprocessing
        nber_workers=multiprocessing.cpu_count()

    pool = Pool(processes=nber_workers)
